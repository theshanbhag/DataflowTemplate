...
public class ODStoEDW_MoviesLoad {
        ...
        lines.apply("moviesData", MapElements.via(
                        new SimpleFunction<Document, TableRow>() {
                            ...
                            public TableRow apply(Document document) {
                                ...
                                {
                                    try{
                                        year = ODStoEDW_MoviesLoad.getIntegerFromDocument(document.getString("year"));
                                    } catch (Exception e2)
                                    {
                                        year = new Integer("1900");
                                    }
                                }
    ...
    public static Integer getIntegerFromDocument(String sYear)
    {
        Integer iYear = null;
        try {
            iYear = new Integer (sYear.substring(0,4));
        } catch (Exception e) {
            System.out.println("Year Formation exception");
            iYear = new Integer ("1900");
        }
        return iYear;
    }
