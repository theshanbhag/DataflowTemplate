 ...
 */
package com.google.cloud.teleport.templates.mongoDbIO;

import static com.google.cloud.teleport.templates.mongoDbIO.FindQuery.bson2BsonDocument;
...
public class MongoDbIO {
    ...
    public abstract static class Read extends PTransform<PBegin, PCollection<Document>> {
        ...
        abstract @Nullable ValueProvider<String> uri();
        ...
        abstract @Nullable ValueProvider<String> database();

        abstract @Nullable ValueProvider<String> collection();
        ...
        abstract static class Builder {
            abstract Builder setUri(ValueProvider<String> uri);
            ...
            abstract Builder setCollection(ValueProvider<String> collection);
         ...
         * </ul>
         */
        public Read withUri(ValueProvider<String> uri) {
        ...
        public Read withCollection(ValueProvider<String> collection) {
    ...
    static class BoundedMongoDbSource extends BoundedSource<Document> {
        ...
        long getDocumentCount() {
            try (MongoClient mongoClient =
                ...
                return getDocumentCount(mongoClient, spec.database().get(), spec.collection().get());
            } catch (Exception e) {
                return -1;
            }
        }
                         ...
                         new MongoClient(
                                 new MongoClientURI(
                                         ...
                                         getOptions(
                                                 ...
                                                 spec.sslInvalidHostNameAllowed(),
                                                 spec.ignoreSSLCertificate())))) {
                return getEstimatedSizeBytes(mongoClient, spec.database().get(), spec.collection().get());
            }
        }
                         ...
                         new MongoClient(
                                 new MongoClientURI(
                                         ...
                                         getOptions(
                                                 ...
                                                 spec.sslInvalidHostNameAllowed(),
                                                 spec.ignoreSSLCertificate())))) {
                MongoDatabase mongoDatabase = mongoClient.getDatabase(spec.database().get());
                    ...
                    if (spec.bucketAuto()) {
                        ...
                        if (spec.numSplits() <= 0) {
                            ...
                            long estimatedSizeBytes =
                                    getEstimatedSizeBytes(mongoClient, spec.database().get(), spec.collection().get());
        ...
        static List<Document> buildAutoBuckets(MongoDatabase mongoDatabase, Read spec) {
            ...
            MongoCollection<Document> mongoCollection = mongoDatabase.getCollection(spec.collection().get());
    ...
    private static class BoundedMongoDbReader extends BoundedSource.BoundedReader<Document> {
        ...
        public boolean start() {
            ...
            MongoDatabase mongoDatabase = client.getDatabase(spec.database().get());
            MongoCollection<Document> mongoCollection = mongoDatabase.getCollection(spec.collection().get());
    ...
    public abstract static class Write extends PTransform<PCollection<Document>, PDone> {
         ...
         * </ul>
         */
        public Write withUri(ValueProvider<String> uri) {
        ...
        /** Sets the database to use. */
        public Write withDatabase(ValueProvider<String> database) {
            checkArgument(database != null, "database can not be null");
            return builder().setDatabase(database).build();
        }

        /** Sets the collection where to write data in the database. */
        public Write withCollection(ValueProvider<String> collection) {
            checkArgument(collection != null, "collection can not be null");
            return builder().setCollection(collection).build();
        }
